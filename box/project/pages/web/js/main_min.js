                    ...
                    resolve: {
                        deps: ['$ocLazyLoad', function ($ocLazyLoad) {
                            return $ocLazyLoad.load({
                                ...
                                files: ['../dist/js/web/controller/DashboardController.min.js']
                            });
                        }]
                    }
                })
                    ...
                    resolve: {
                        deps: ['$ocLazyLoad', function ($ocLazyLoad) {
                            return $ocLazyLoad.load({
                                ...
                                insertBefore: '#ng_load_plugins_before',
                                files: [
                                    '../dist/js/web/controller/myWorkLogController.min.js'
                                ]
                            });
                        }]
                    }
                    ...
                    resolve: {
                        deps: ['$ocLazyLoad', function ($ocLazyLoad) {
                            return $ocLazyLoad.load({
                                ...
                                insertBefore: '#ng_load_plugins_before',
                                files: [
                                    '../dist/js/web/controller/profileViewController.min.js'
                                ]
                            });
                        }]
                    }
                    ...
                    resolve: {
                        deps: ['$ocLazyLoad', function ($ocLazyLoad) {
                            return $ocLazyLoad.load({
                                ...
                                insertBefore: '#ng_load_plugins_before',
                                files: [
                                    '../dist/js/web/controller/myRecordsController.min.js'
                                ]
                            });
                        }]
                    }
                    ...
                    resolve: {
                        deps: ['$ocLazyLoad', function ($ocLazyLoad) {
                            return $ocLazyLoad.load({
                                name: 'app',
                                insertBefore: '#ng_load_plugins_before',
                                files: ['../dist/js/web/controller/myRecordsController.min.js']
                            });
                        }]
                    }
                })
                    ...
                    resolve: {
                        deps: ['$ocLazyLoad', function ($ocLazyLoad) {
                            return $ocLazyLoad.load({
                                ...
                                insertBefore: '#ng_load_plugins_before',
                                files: [
                                    '../dist/js/web/controller/myRepairController.min.js'
                                ]
                            });
                        }]
                    }
                    ...
                    resolve: {
                        deps: ['$ocLazyLoad', function ($ocLazyLoad) {
                            return $ocLazyLoad.load({
                                name: 'MetronicApp',
                                insertBefore: '#ng_load_plugins_before',
	                            files: ['../dist/js/web/controller/viewMyRepairController.min.js',
                    ...
                    resolve: {
                        deps: ['$ocLazyLoad', function ($ocLazyLoad) {
                            return $ocLazyLoad.load({
                                ...
                                insertBefore: '#ng_load_plugins_before',
                                files: [
                                    '../dist/js/web/controller/materialUseController.min.js'
                                ]
                            });
                        }]
                    }
                    ...
                    resolve: {
                        deps: ['$ocLazyLoad', function ($ocLazyLoad) {
                            return $ocLazyLoad.load({
                                name: 'app',
                                insertBefore: '#ng_load_plugins_before',
                                files: ['../dist/js/web/controller/myLostFoundController.min.js']
                            });
                        }]
                    }
                })
                    ...
                    resolve: {
                        deps: ['$ocLazyLoad', function ($ocLazyLoad) {
                            return $ocLazyLoad.load({
                                name: 'app',
                                insertBefore: '#ng_load_plugins_before',
                                files: ['../dist/js/web/controller/myFleaMarketController.min.js']
                            });
                        }]
                    }
                })
                    ...
                    resolve: {
                        deps: ['$ocLazyLoad', function ($ocLazyLoad) {
                            return $ocLazyLoad.load({
                                ...
                                insertBefore: '#ng_load_plugins_before',
                                files: ['' +
                                '../dist/js/web/controller/mySuggestionController.min.js']
                            });
                        }]
                    }
                })
                    ...
                    resolve: {
                        deps: ['$ocLazyLoad', function ($ocLazyLoad) {
                            return $ocLazyLoad.load({
                                name: 'app',
                                insertBefore: '#ng_load_plugins_before',
                                files: ['../dist/js/web/controller/newsController.min.js']
                            });
                        }]
                    }
                })
                    ...
                    resolve: {
                        deps: ['$ocLazyLoad', function ($ocLazyLoad) {
                            return $ocLazyLoad.load({
                                ...
                                insertBefore: '#ng_load_plugins_before',
                                files: [
                                    '../dist/js/web/controller/suggestionController.min.js'
                                ]
                            });
                        }]
                    }
                    ...
                    resolve: {
                        deps: ['$ocLazyLoad', function ($ocLazyLoad) {
                            return $ocLazyLoad.load({
                                name: 'app',
                                insertBefore: '#ng_load_plugins_before',
                                files: ['../dist/js/web/controller/mySuggestionController.min.js']
                            });
                        }]
                    }
                })
                    ...
                    resolve: {
                        deps: ['$ocLazyLoad', function ($ocLazyLoad) {
                            return $ocLazyLoad.load({
                                name: 'app',
                                insertBefore: '#ng_load_plugins_before',
                                files: ['../dist/js/web/controller/suggestionController.min.js']
                            });
                        }]
                    }
                })
                    ...
                    resolve: {
                        deps: ['$ocLazyLoad', function ($ocLazyLoad) {
                            return $ocLazyLoad.load({
                                name: 'app',
                                insertBefore: '#ng_load_plugins_before',
                                files: ['../dist/js/web/controller/commonRepairController.min.js']
                            });
                        }]
                    }
                })
                    ...
                    resolve: {
                        deps: ['$ocLazyLoad', function ($ocLazyLoad) {
                            return $ocLazyLoad.load({
                                name: 'app',
                                insertBefore: '#ng_load_plugins_before',
                                files: ['../dist/js/web/controller/commonRepairDetailController.min.js']
                            });
                        }]
                    }
                })
                    ...
                    resolve: {
                        deps: ['$ocLazyLoad', function ($ocLazyLoad) {
                            return $ocLazyLoad.load({
                                ...
                                insertBefore: '#ng_load_plugins_before',
                                files: [
                                    '../dist/js/web/controller/specialRepairController.min.js'
                                ]
                            });
                        }]
                    }
                    ...
                    resolve: {
                        deps: ['$ocLazyLoad', function ($ocLazyLoad) {
                            return $ocLazyLoad.load({
                                name: 'app',
                                insertBefore: '#ng_load_plugins_before',
                                files: ['../dist/js/web/controller/specialRepairController.min.js']
                            });
                        }]
                    }
                })
                    ...
                    resolve: {
                        deps: ['$ocLazyLoad', function ($ocLazyLoad) {
                            return $ocLazyLoad.load({
                                name: 'app',
                                insertBefore: '#ng_load_plugins_before',
                                files: ['../dist/js/web/controller/materialController.min.js']
                            });
                        }]
                    }
                })
                    ...
                    resolve: {
                        deps: ['$ocLazyLoad', function ($ocLazyLoad) {
                            return $ocLazyLoad.load({
                                ...
                                insertBefore: '#ng_load_plugins_before',
                                files: [
                                    '../dist/js/web/controller/serviceController.min.js'
                                ]
                            });
                        }]
                    }
                    ...
                    resolve: {
                        deps: ['$ocLazyLoad', function ($ocLazyLoad) {
                            return $ocLazyLoad.load({
                                name: 'app',
                                insertBefore: '#ng_load_plugins_before',
                                files: ['../dist/js/web/controller/lostFoundController.min.js']
                            });
                        }]
                    }
                })
                    ...
                    resolve: {
                        deps: ['$ocLazyLoad', function ($ocLazyLoad) {
                            return $ocLazyLoad.load({
                                name: 'app',
                                insertBefore: '#ng_load_plugins_before',
                                files: ['../dist/js/web/controller/fleaMarketController.min.js']
                            });
                        }]
                    }
                })
                    ...
                    resolve: {
                        deps: ['$ocLazyLoad', function ($ocLazyLoad) {
                            return $ocLazyLoad.load({
                                name: 'app',
                                insertBefore: '#ng_load_plugins_before',
                                files: ['../dist/js/web/controller/workLogController.min.js']
                            });
                        }]
                    }
                })
                    ...
                    resolve: {
                        deps: ['$ocLazyLoad', function ($ocLazyLoad) {
                            return $ocLazyLoad.load({
                                name: 'app',
                                insertBefore: '#ng_load_plugins_before',
                                files: ['../dist/js/web/controller/myWorkLogController.min.js']
                            });
                        }]
                    }
                })
                    ...
                    resolve: {
                        deps: ['$ocLazyLoad', function ($ocLazyLoad) {
                            return $ocLazyLoad.load({
                                name: 'app',
                                insertBefore: '#ng_load_plugins_before',
                                files: ['../dist/js/web/controller/hourStatisticsController.min.js',
                                    '../assets/global/plugins/echarts/4.0.2/echarts.min.js'
                                ]
                            });
                        }]
                    ...
                    resolve: {
                        deps: ['$ocLazyLoad', function ($ocLazyLoad) {
                            return $ocLazyLoad.load({
                                name: 'app',
                                insertBefore: '#ng_load_plugins_before',
                                files: ['../dist/js/web/controller/weekStatisticsController.min.js',
                                    '../assets/global/plugins/echarts/4.0.2/echarts.min.js'
                                ]
                            });
                        }]
                    ...
                    resolve: {
                        deps: ['$ocLazyLoad', function ($ocLazyLoad) {
                            return $ocLazyLoad.load({
                                name: 'app',
                                insertBefore: '#ng_load_plugins_before',
                                files: ['../dist/js/web/controller/monthStatisticsController.min.js',
                                    '../assets/global/plugins/echarts/4.0.2/echarts.min.js'
                                ]
                            });
                        }]
                    ...
                    resolve: {
                        deps: ['$ocLazyLoad', function ($ocLazyLoad) {
                            return $ocLazyLoad.load({
                                name: 'app',
                                insertBefore: '#ng_load_plugins_before',
                                files: ['../dist/js/web/controller/repairOriginStatisticsController.min.js',
                                    '../assets/global/plugins/echarts/4.0.2/echarts.min.js']
                            });
                        }]
                    }
                    ...
                    resolve: {
                        deps: ['$ocLazyLoad', function ($ocLazyLoad) {
                            return $ocLazyLoad.load({
                                name: 'app',
                                insertBefore: '#ng_load_plugins_before',
                                files: ['../dist/js/web/controller/maintenanceTypeStatisticsController.min.js',
                                    '../assets/global/plugins/echarts/4.0.2/echarts.min.js']
                            });
                        }]
                    }
                    ...
                    resolve: {
                        deps: ['$ocLazyLoad', function ($ocLazyLoad) {
                            return $ocLazyLoad.load({
                                name: 'app',
                                insertBefore: '#ng_load_plugins_before',
                                files: ['../dist/js/web/controller/maintenanceAreaStatisticsController.min.js',
                                    '../assets/global/plugins/echarts/4.0.2/echarts.min.js']
                            });
                        }]
                    }
                    ...
                    resolve: {
                        deps: ['$ocLazyLoad', function ($ocLazyLoad) {
                            return $ocLazyLoad.load({
                                name: 'app',
                                insertBefore: '#ng_load_plugins_before',
                                files: ['../dist/js/web/controller/timeCostStatisticsController.min.js',
                                    '../assets/global/plugins/echarts/4.0.2/echarts.min.js']
                            });
                        }]
                    }
                    ...
                    resolve: {
                        deps: ['$ocLazyLoad', function ($ocLazyLoad) {
                            return $ocLazyLoad.load({
                                name: 'app',
                                insertBefore: '#ng_load_plugins_before',
                                files: ['../dist/js/web/controller/maintenanceStatusStatisticsController.min.js',
                                    '../assets/global/plugins/echarts/4.0.2/echarts.min.js']
                            });
                        }]
                    }
                    ...
                    resolve: {
                        deps: ['$ocLazyLoad', function ($ocLazyLoad) {
                            return $ocLazyLoad.load({
                                name: 'app',
                                insertBefore: '#ng_load_plugins_before',
                                files: ['../dist/js/web/controller/evaluationStatisticsController.min.js',
                                    '../assets/global/plugins/echarts/4.0.2/echarts.min.js']
                            });
                        }]
                    }
                    ...
                    resolve: {
                        deps: ['$ocLazyLoad', function ($ocLazyLoad) {
                            return $ocLazyLoad.load({
                                name: 'app',
                                insertBefore: '#ng_load_plugins_before',
                                files: ['../dist/js/web/controller/dutyController.min.js']
                            });
                        }]
                    }
                })
