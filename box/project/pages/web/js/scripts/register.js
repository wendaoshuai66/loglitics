...
(function ($) {
    ...
    function require(options){
        var rule={//验证规则
            ...
            uname:/^[a-zA-Z0-9]*([a-zA-Z][0-9]|[0-9][a-zA-Z])[a-zA-Z0-9]*$/,
            personName: /^[\u4e00-\u9fa5a-zA-Z]+$/,//纯中文和字母
            zh:/^[\u4e00-\u9fa5]+$/,//纯中文
        ...
        this.rules={
            ...
            isPersonName: function(value, errorMsg) {
                errorMsg=errorMsg||" ";
                if (!rule.personName.test(value)) return errorMsg;
            },
