angular.module("MetronicApp").controller('friendlyLinkController',
    ['$scope', '$http', '$compile', '$location', '$filter', '$timeout','$state', friendlyLinkController]);
function friendlyLinkController($scope, $http, $compile, $location, $filter, $timeout,$state) {
    $scope.data = {};
    $scope.searchObj = {};
    // controller名称初始化
    $scope.controllerName = 'link';
    // 单选框初始化
    ...
    $scope.url = url;
    $scope.reloadUrl = url;
    $scope.initDataTablesName = 'friendlyLinkDataTable';
    dataTables.init($scope, $http, $compile, $location, $filter);
    // 对于需要校验的输入内容清空操作
    $scope.resetInputList = ['title', 'url'];
    // 添加页面
    $scope.addModal = function() {
    	//var linkAddScope = $scope.getScope('linkAdd');
    	$scope.data = {};
    ...
    $scope.changeStatus = function() {
        ...
        $scope.addLoading();
        $scope.url = "changeFriendLinkStatus";
...
angular.module("MetronicApp").controller('linkAddController', ['$scope', '$http', '$compile', '$location', '$filter', linkAddController]);
function linkAddController($scope, $http, $compile, $location, $filter) {
    ...
    $scope.checkRepeat = function() {
        ...
        $scope.repeatUrl = "checkRepeatFriendLink";
