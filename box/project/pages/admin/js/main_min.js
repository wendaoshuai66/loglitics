                    ...
                    resolve: {
                        deps: ['$ocLazyLoad', function ($ocLazyLoad) {
                            return $ocLazyLoad.load({
                                ...
                                files: [
                                    '../dist/js/admin/controller/DashboardController.min.js',
                                ]
                            });
                        }]
                    }
                    ...
                    resolve: {
                        deps: ['$ocLazyLoad', function ($ocLazyLoad) {
                            return $ocLazyLoad.load({
                                name: 'app',
                                insertBefore: '#ng_load_plugins_before',
                                files: ['../dist/js/admin/controller/materialCategoryController.min.js']
                            });
                        }]
                    }
                })
                    ...
                    resolve: {
                        deps: ['$ocLazyLoad', function ($ocLazyLoad) {
                            return $ocLazyLoad.load({
                                name: 'app',
                                insertBefore: '#ng_load_plugins_before',
                                files: ['../dist/js/admin/controller/materialUnitController.min.js']
                            });
                        }]
                    }
                })
                    ...
                    resolve: {
                        deps: ['$ocLazyLoad', function ($ocLazyLoad) {
                            return $ocLazyLoad.load({
                                name: 'app',
                                insertBefore: '#ng_load_plugins_before',
                                files: ['../dist/js/admin/controller/materialController.min.js']
                            });
                        }]
                    }
                })
                    ...
                    resolve: {
                        deps: ['$ocLazyLoad', function ($ocLazyLoad) {
                            return $ocLazyLoad.load({
                                name: 'app',
                                insertBefore: '#ng_load_plugins_before',
                                files: ['../dist/js/admin/controller/storageController.min.js']
                            });
                        }]
                    }
                })
                    ...
                    resolve: {
                        deps: ['$ocLazyLoad', function ($ocLazyLoad) {
                            return $ocLazyLoad.load({
                                name: 'app',
                                insertBefore: '#ng_load_plugins_before',
                                files: ['../dist/js/admin/controller/stockRemovalController.min.js']
                            });
                        }]
                    }
                })
                    ...
                    resolve: {
                        deps: ['$ocLazyLoad', function ($ocLazyLoad) {
                            return $ocLazyLoad.load({
                                name: 'app',
                                insertBefore: '#ng_load_plugins_before',
                                files: ['../dist/js/admin/controller/campusController.min.js']
                            });
                        }]
                    }
                })
                    ...
                    resolve: {
                        deps: ['$ocLazyLoad', function ($ocLazyLoad) {
                            return $ocLazyLoad.load({
                                name: 'app',
                                insertBefore: '#ng_load_plugins_before',
                                files: ['../dist/js/admin/controller/departmentController.min.js']
                            });
                        }]
                    }
                })
                    ...
                    resolve: {
                        deps: ['$ocLazyLoad', function ($ocLazyLoad) {
                            return $ocLazyLoad.load({
                                name: 'app',
                                insertBefore: '#ng_load_plugins_before',
                                files: ['../dist/js/admin/controller/positionController.min.js']
                            });
                        }]
                    }
                })
                    ...
                    resolve: {
                        deps: ['$ocLazyLoad', function ($ocLazyLoad) {
                            return $ocLazyLoad.load({
                                name: 'app',
                                insertBefore: '#ng_load_plugins_before',
                                files: ['../dist/js/admin/controller/maintenanceTypeController.min.js']
                            });
                        }]
                    }
                })
                    ...
                    resolve: {
                        deps: ['$ocLazyLoad', function ($ocLazyLoad) {
                            return $ocLazyLoad.load({
                                name: 'app',
                                insertBefore: '#ng_load_plugins_before',
                                files: ['../dist/js/admin/controller/maintenanceCategoryController.min.js']
                            });
                        }]
                    }
                })
                    ...
                    resolve: {
                        deps: ['$ocLazyLoad', function ($ocLazyLoad) {
                            return $ocLazyLoad.load({
                                name: 'app',
                                insertBefore: '#ng_load_plugins_before',
                                files: ['../dist/js/admin/controller/maintenanceAreaController.min.js']
                            });
                        }]
                    }
                })
                    ...
                    resolve: {
                        deps: ['$ocLazyLoad', function ($ocLazyLoad) {
                            return $ocLazyLoad.load({
                                name: 'app',
                                insertBefore: '#ng_load_plugins_before',
                                files: ['../dist/js/admin/controller/maintenanceStatusController.min.js']
                            });
                        }]
                    }
                })
                    ...
                    resolve: {
                        deps: ['$ocLazyLoad', function ($ocLazyLoad) {
                            return $ocLazyLoad.load({
                                name: 'app',
                                insertBefore: '#ng_load_plugins_before',
                                files: ['../dist/js/admin/controller/inforModuleController.min.js']
                            });
                        }]
                    }
                })
                    ...
                    resolve: {
                        deps: ['$ocLazyLoad', function ($ocLazyLoad) {
                            return $ocLazyLoad.load({
                                name: 'app',
                                insertBefore: '#ng_load_plugins_before',
                                files: ['../dist/js/admin/controller/friendlyLinkController.min.js']
                            });
                        }]
                    }
                })
                    ...
                    resolve: {
                        deps: ['$ocLazyLoad', function ($ocLazyLoad) {
                            return $ocLazyLoad.load({
                                name: 'app',
                                insertBefore: '#ng_load_plugins_before',
                                files: ['../dist/js/admin/controller/serviceController.min.js']
                            });
                        }]
                    }
                })
                    ...
                    resolve: {
                        deps: ['$ocLazyLoad', function ($ocLazyLoad) {
                            return $ocLazyLoad.load({
                                name: 'app',
                                insertBefore: '#ng_load_plugins_before',
                                files: ['../dist/js/admin/controller/teacherController.min.js']
                            });
                        }]
                    }
                })
                    ...
                    resolve: {
                        deps: ['$ocLazyLoad', function ($ocLazyLoad) {
                            return $ocLazyLoad.load({
                                name: 'app',
                                insertBefore: '#ng_load_plugins_before',
                                files: ['../dist/js/admin/controller/maintenanceWorkerController.min.js']
                            });
                        }]
                    }
                })
                    ...
                    resolve: {
                        deps: ['$ocLazyLoad', function ($ocLazyLoad) {
                            return $ocLazyLoad.load({
                                name: 'app',
                                insertBefore: '#ng_load_plugins_before',
                                files: ['../dist/js/admin/controller/studentController.min.js']
                            });
                        }]
                    }
                })
                    ...
                    resolve: {
                        deps: ['$ocLazyLoad', function ($ocLazyLoad) {
                            return $ocLazyLoad.load({
                                name: 'app',
                                insertBefore: '#ng_load_plugins_before',
                                files: ['../dist/js/admin/controller/userLoginLogController.min.js']
                            });
                        }]
                    }
                })
                                    ...
                                    return $ocLazyLoad.load([
                                        {
                                            ...
                                            files: ['../dist/js/admin/controller/angular-file-upload.min.js']
                                        },
                                        {
                                            name: 'app',
                                            insertBefore: '#ng_load_plugins_before',
                                            files: [
                                                '../dist/js/admin/controller/inforPictureController.min.js',
                                                '../dist/js/admin/controller/slideUploadController.min.js']
                                        }]);
                                }]
                        }
                    })
                                ...
                                function ($ocLazyLoad) {
                                    return $ocLazyLoad.load([
                                        ...
                                        },
                                        {
                                            ...
                                            insertBefore: '#ng_load_plugins_before',
                                            files: [
                                                '../dist/js/admin/controller/slideController.min.js',
                                                '../dist/js/admin/controller/slideUploadController.min.js']
                                        }]);
                                }]
                        }
                    ...
                    resolve: {
                        deps: ['$ocLazyLoad', function ($ocLazyLoad) {
                            return $ocLazyLoad.load({
                                name: 'app',
                                insertBefore: '#ng_load_plugins_before',
                                files: ['../dist/js/admin/controller/inforTextController.min.js']
                            });
                        }]
                    }
                })
                    ...
                    resolve: {
                        deps: ['$ocLazyLoad', function ($ocLazyLoad) {
                            return $ocLazyLoad.load({
                                name: 'app',
                                insertBefore: '#ng_load_plugins_before',
                                files: ['../dist/js/admin/controller/fleaMarketController.min.js']
                            });
                        }]
                    }
                })
                    ...
                    resolve: {
                        deps: ['$ocLazyLoad', function ($ocLazyLoad) {
                            return $ocLazyLoad.load({
                                name: 'app',
                                insertBefore: '#ng_load_plugins_before',
                                files: ['../dist/js/admin/controller/lostFoundController.min.js']
                            });
                        }]
                    }
                })
                    ...
                    resolve: {
                        deps: ['$ocLazyLoad', function ($ocLazyLoad) {
                            return $ocLazyLoad.load({
                                name: 'app',
                                insertBefore: '#ng_load_plugins_before',
                                files: ['../dist/js/admin/controller/workLogController.min.js']
                            });
                        }]
                    }
                })
                    ...
                    resolve: {
                        deps: ['$ocLazyLoad', function ($ocLazyLoad) {
                            return $ocLazyLoad.load({
                                name: 'app',
                                insertBefore: '#ng_load_plugins_before',
                                files: ['../dist/js/admin/controller/dutyController.min.js']
                            });
                        }]
                    }
                })
                                ...
                                function ($ocLazyLoad) {
                                    return $ocLazyLoad
                                        .load({
                                            name: 'app',
                                            insertBefore: '#ng_load_plugins_before',
                                            files: ['../dist/js/admin/controller/maintenanceRecordsController.min.js']
                                        });
                                }]
                        }
                    })
                                ...
                                function ($ocLazyLoad) {
                                    return $ocLazyLoad
                                        .load({
                                            name: 'app',
                                            insertBefore: '#ng_load_plugins_before',
                                            files: ['../dist/js/admin/controller/specialMaintenanceController.min.js']
                                        });
                                }]
                        }
                    })
                                ...
                                function ($ocLazyLoad) {
                                    return $ocLazyLoad
                                        .load({
                                            name: 'app',
                                            insertBefore: '#ng_load_plugins_before',
                                            files: ['../dist/js/admin/controller/maintenanceEvaluationController.min.js']
                                        });
                                }]
                        }
                    })
