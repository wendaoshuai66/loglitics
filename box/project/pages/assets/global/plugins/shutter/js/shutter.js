;(function ($, window, document, undefined) {
    ...
    Shutter.prototype = {
        ...
        toggleMove: function (command, index) {
            ...
            this.$shutterDesc.animate({bottom: -55});

            var random = function (min, max) {
                return Math.floor(Math.random() * (max + 1) - min);
            };
            if(this.opts.wayToPlay == 'special') {
                this.moveSwitch(random(0, 13) + 5 , command, index);
            }
            else {
        ...
        inital: function (elem) {
            var self = this;
            this.$shutter = elem;
            this.$shutterItem = this.$shutter.find('a');
            ...
            this.$nextBtn.bind('click', function () {
                if (self.b_stop) {
                    ...
                    self.$shutterDesc.animate({bottom: -55});
                }
                return false;
            });
