...
(function (factory) {
  ...
  var dialog = renderer.create('<div class="modal fade" data-backdrop="static" tabindex="-1" aria-hidden="false"/>', function ($node, options) {
    $node.html([
      (options.title ?
      '    <div class="modal-header">' +
      '      <button type="button" class="modal_close" data-dismiss="modal" aria-hidden="true">x</button>' +
      '      <h4 class="modal-title" style="padding-top: 8px;">' + options.title + '</h4>' +
      '    </div>' : ''
      ),
    ...
    this.initialize = function () {
      ...
      var body = '<div class="form-group">' +
                 ...
                 (!options.disableLinkTarget ?
                   '<div class="checkbox">' +
                     '<label>' + '<input type="checkbox" checked style="margin-left :0px !important;"> ' + '<span style="margin-left: 30px">'+lang.link.openInNewWindow+'</span>'+'</label>' +
                   '</div>' : ''
                 );
  ...
  var ImageDialog = function (context) {
    ...
    this.initialize = function () {
      ...
      var body = '选择图片' + '&nbsp;&nbsp;'  + '<div class="form-group btn btn-danger btn-file">' +
                   // '<label>' + lang.image.selectFromFiles + '</label>' +
                   '<span class="glyphicon glyphicon-picture" aria-hidden="true"></span>'  + '&nbsp;&nbsp;本地图片' +
