...
@Entity
@Table(name = "infor_module")
public class InforModule implements java.io.Serializable {
    ...
    // private Integer inforType;// 模块类型

    private String description; // 描述

    private Integer homeShow = 0;// 首页显示标志位（0：隐藏，1：显示）
