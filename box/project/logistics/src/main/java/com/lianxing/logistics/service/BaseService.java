...
public interface BaseService {
    ...
    String getMd5String(User user, String newPassword);

    JSONObject getJSONFromRequest(HttpServletRequest request);

    JSONObject getJsonFromUpdateOpenId(HttpServletRequest request);
}
