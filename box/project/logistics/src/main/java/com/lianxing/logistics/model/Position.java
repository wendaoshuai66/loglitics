...
public class Position implements java.io.Serializable {
    ...
    private String description;// 职务的描述
    ...
    private Integer cardDisplay = 1;// 名片显示标志位（0：隐藏，1：显示）
    ...
    public Integer getCardDisplay() {
        return cardDisplay;
    }

    public void setCardDisplay(Integer cardDisplay) {
