...
public class MaterialCategoryDaoImpl extends BaseDaoImpl implements MaterialCategoryDao {
    ...
    public Long getMaterialCategorAllCountFromPara(Map<String, Map> para, boolean ifAll) {
        ...
        String sql = "SELECT COUNT(1) AS count FROM material_category c  WHERE 1=1";
        if (!ifAll) {
            sql += " and status = 1 ";
        }
        sql += " and ifDelete = 0 ";
